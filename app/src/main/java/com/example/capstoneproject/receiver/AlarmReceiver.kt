package com.example.capstoneproject.receiver
...
import com.example.capstoneproject.notification.AlarmNotificationHelper
...
class AlarmReceiver :BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent?) {
        ...
        // Get the phone's alarm type ringtone
